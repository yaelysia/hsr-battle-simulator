...
它只建立加权单选 IR、身份、父子来源和严格 codec。S8C1B、S8C1C 必须在 S8C1A 验收后根据实际
剩余调用面分别制定；目前没有可直接实施的卡。
...
| 已验收 | S8A、S8A-R1；S8B1、S8B2、S8B1-R2；S8B3A-S8B3C；S8B4A-S8B4B；S8B5A-S8B5C；S8B6 及对应聚合项 |
