...
2. `P9-S8B_ATOMIC_TASK_GRAPH_RUNTIME.md`
3. `P9-S8C_HIT_BARRIER_RANDOM_SEQUENCE.md`
...
- S8B 的权威输入是 S8A 目录与已 lower 的 effect/condition/target 引用；输出是原子任务图事务，
  不决定 projectile、parallel 或随机时序。
