...
- [ ] R9: close the exact ordinary Aglaea CreateServant11402 -> formal caller -> source-backed servant spawn path. **2026-09-14: partial / NEEDS_REPLAN, R9-G01**, inspected business master `f8e8a053ef591e1aeeb99956d46acd8390676c6f`: generic source-bearing task lowering and the definition/spawn consumer exist, but executable CreateServant caller transport is missing. See [Owned Servant Creation / Ownership / Runtime Admission v1](../../../../../docs/tbgd_evidence/shared/owned_servant_runtime_admission_v1.md). Downstream selected build/stat/birth/registry/action closure and E are not established; retain spawn-source proof gates, stop R9 and return to integration/planning rather than expand archaeology or automatically enter R10.
