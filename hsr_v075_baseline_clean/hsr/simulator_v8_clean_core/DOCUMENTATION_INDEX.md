...
checkpoint: v8_p8_s1_equipment_type_contract_ready_for_review.md
```
...
P8-S1 typed equipment and build architecture accepted
next stage: P8-S2 formal character build input and base panel
```
...
- P8-S0 装备来源与机制基线、P8-S1 类型化装备与构筑架构均已独立验收。S1 已建立正式结构和失败边界，但尚未 lower 真实装备或改变 runtime 行为。
...
P7-S0 至 P7-S19 已全部验收，P8-S0 与 P8-S1 也已通过独立验收。当前装备 / 构筑主线下一步只执行 P8-S2；不能修改 P7 已完成口径来掩盖保留缺口，也不能把 S1 的类型化结构误读为真实装备 lowering、数值装配或效果执行已经完成。
