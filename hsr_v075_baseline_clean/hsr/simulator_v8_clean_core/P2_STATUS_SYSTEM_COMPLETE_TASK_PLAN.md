...
- [x] P2-S3 施加、叠层、刷新、替换、共存完整语义完成。
- [x] P2-S4 持续时间、tick、过期、跨波清理完整语义完成。
- [x] P2-S5 概率、效果抵抗、控制抵抗、免疫完整语义完成。
- [x] P2-S6 控制状态对行动、队列、时间线的完整语义完成。
- [x] P2-S7 状态数值影响和动态值绑定完整语义完成。
- [x] P2-S8 DoT / 状态伤害 / 状态触发伤害完整语义完成。
- [x] P2-S9 移除、驱散、净化、不可驱散完整语义完成。
- [x] P2-S10 状态回调事件族和任务 opcode 覆盖完成。
